...
final class AppState: ObservableObject {
    ...
    /// Returns the persisted API key from UserDefaults, or empty string as fallback
    ...
    private init() {
        ...
        let config = APIClientConfiguration(baseURL: persistedURL, apiKey: persistedAPIKey.isEmpty ? nil : persistedAPIKey)
    ...
    private func recreateAPIClient() {
        let config = APIClientConfiguration(baseURL: apiBaseURL, apiKey: apiKey.isEmpty ? nil : apiKey)
