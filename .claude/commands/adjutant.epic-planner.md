---
description: Create structured epic hierarchies for new features, major refactorings, and large tasks. Generates spec artifacts and creates real beads with wired dependencies. Use for "Create a new epic", "Plan a feature", "New epic for...", or any significant body of work.
handoffs:
...
Generate four files in order. Use the templates in `skills/epic-planner/references/templates.md` as the structural guide -- fill them with content derived from the user's description and your clarification answers.
...
Use `bd` CLI to create real beads matching the hierarchy in beads-import.md. See `skills/epic-planner/references/beads-workflow.md` for the exact commands and conventions.
...
- `skills/epic-planner/references/templates.md` - Speckit-compatible templates for all four artifacts
- `skills/epic-planner/references/beads-workflow.md` - `bd` CLI commands, dependency wiring, and ID conventions
