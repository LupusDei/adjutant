...
Adjutant was originally inspired by [Gastown Boy](https://github.com/wsaults/gastown-boy) by Will Saults. While the project has since been completely rewritten and bears little resemblance to the original, the retro terminal aesthetic and the idea of a Pip-Boy-style dashboard for monitoring agents trace back to Will's work. Thank you for the spark.
