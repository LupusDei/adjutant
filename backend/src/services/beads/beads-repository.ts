/**
 * Beads repository module — the sole gateway to the `bd` CLI.
 *
 * All functions that interact with the beads database (listing, fetching,
 * updating, graph queries) live here. No other module in the beads/
 * directory may import from `bd-client` directly.
 *
 * IMPORTANT: Adjutant is the dashboard for ALL of Gas Town. Functions here
 * query town-level and rig-level beads databases as appropriate.
 */
...
// ============================================================================
// Exported Functions — Prefix Map Management
// ============================================================================
...
export function startPrefixMapRefreshScheduler(
  ...
  buildPrefixMap()
    ...
    .catch((err) => {
      console.error("[BeadsRepository] Initial prefix map build failed:", err);
    });
  ...
  prefixMapRefreshIntervalId = setInterval(() => {
    buildPrefixMap()
      ...
      .catch((err) => {
        console.error("[BeadsRepository] Prefix map refresh failed:", err);
      });
  }, intervalMs);
...
// ============================================================================
// Exported Functions — Bead Sources
// ============================================================================
...
// ============================================================================
// Exported Functions — Single-Bead Operations
// ============================================================================
...
// ============================================================================
// Exported Functions — List Operations
// ============================================================================
...
// ============================================================================
// Exported Functions — Epic Operations
// ============================================================================
...
// ============================================================================
// Exported Functions — Recently Closed
// ============================================================================
...
// ============================================================================
// Exported Functions — Project Overview
// ============================================================================
...
// ============================================================================
// Exported Functions — Dependency Graph
// ============================================================================
...
// ============================================================================
// Test-only exports (prefixed with _ to denote internal)
// ============================================================================
...
/** @internal Exported for testing */
export const _parseStatusFilter = parseStatusFilter;
