...
const DIRECT_MESSAGE_DESCRIPTION = [
  ...
  "  sessionsFound 0 — the agent is a real, registered one (an unknown name is rejected before",
  "  this point, so a 0 can never mean a typo) but no session is on record for them, and there",
  "  was nothing to deliver into.",
